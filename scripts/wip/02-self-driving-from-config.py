...
# Example usage:
# python 02-self-driving-from-config.py \
#--config /home/daniel/git/carla-driver-data/scripts/wip/config_1920x1080.json \
#--model /home/daniel/git/carla-driver-data/scripts/best_steering_model_20250318-095828.pth